...
#ifndef CECIL_INCL_WORLDCOLLISION_H
#define CECIL_INCL_WORLDCOLLISION_H
#ifdef PRAGMA_ONCE
  #pragma once
#endif
...
public:
  ...
  void ClipMovingSphereToTriangle(
  ...
  void ClipMoveToTriangle(const FLOAT3D &v0, const FLOAT3D &v1, const FLOAT3D &v2);
...
// these are filled by clipping algorithm:
  ...
  /* Constructor. */
  CCecilClipMove(class CCecilMovableEntity *penEntity);
};
