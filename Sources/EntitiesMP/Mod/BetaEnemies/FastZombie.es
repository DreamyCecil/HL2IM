...
components:
  ...
  1 model   MODEL_FREAK       "Models\\Enemies\\FastZombie\\Zombie.mdl",
  2 model   MODEL_CHAINSAW    "Models\\Enemies\\FastZombie\\Headcrab.mdl",
  3 texture TEXTURE_FREAK     "Models\\Enemies\\FastZombie\\Zombie.tex",
  4 texture TEXTURE_CHAINSAW  "Models\\Enemies\\FastZombie\\Headcrab.tex",

// ************** SOUNDS **************
 50 sound   SOUND_IDLE       "Models\\Enemies\\FastZombie\\Sounds\\Idle.wav",
 51 sound   SOUND_RUN        "Models\\Enemies\\FastZombie\\Sounds\\Run.wav",
 54 sound   SOUND_ATTACK     "Models\\Enemies\\FastZombie\\Sounds\\Attack.wav",
 55 sound   SOUND_WOUND      "Models\\Enemies\\FastZombie\\Sounds\\Wound.wav",
 56 sound   SOUND_DEATH      "Models\\Enemies\\FastZombie\\Sounds\\Death.wav",
 57 sound   SOUND_SIGHT      "Models\\Enemies\\FastZombie\\Sounds\\Sight.wav",
...
functions:
  ...
  {
    CTString str;
    str.PrintF(TRANS("Fast zombie dismembered %s"), strPlayerName);
    return str;
  }
  ...
  virtual const CTFileName &GetComputerMessageName(void) const {
    static DECLARE_CTFILENAME(fnm, "Data\\Messages\\Enemies\\FastZombie.txt");
    return fnm;
  };
  ...
  {
    // Fast zombies can't hurt each other
    if (!IsOfClass(penInflictor, "FastZombie")) {
