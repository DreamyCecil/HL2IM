...
// ************** MAIN MODEL **************
 ...
 10 model   MODEL_SUMMONER        "Models\\Enemies\\Merasmus\\Merasmus.mdl",
 11 texture TEXTURE_SUMMONER      "Models\\Enemies\\Merasmus\\Merasmus.tex",
 12 model   MODEL_STAFF           "Models\\Enemies\\Merasmus\\Staff.mdl",
 13 texture TEXTURE_STAFF         "Models\\Enemies\\Merasmus\\Staff.tex",
 
 16 model   MODEL_DEBRIS01        "Models\\Enemies\\Merasmus\\Debris\\Cloth01.mdl",
 17 model   MODEL_DEBRIS02        "Models\\Enemies\\Merasmus\\Debris\\Cloth02.mdl",
 18 model   MODEL_DEBRIS03        "Models\\Enemies\\Merasmus\\Debris\\Cloth03.mdl",
...
// ************** SOUNDS **************
101 sound  SOUND_LAUGH       "Models\\Enemies\\Merasmus\\Sounds\\Laugh.wav",
102 sound  SOUND_EXPLODE     "Models\\Enemies\\Merasmus\\Sounds\\Explode.wav",
103 sound  SOUND_TREMORS     "Models\\Enemies\\Merasmus\\Sounds\\Tremors.wav",
104 sound  SOUND_DEATH       "Models\\Enemies\\Merasmus\\Sounds\\Death.wav",
105 sound  SOUND_LASTWORDS   "Models\\Enemies\\Merasmus\\Sounds\\LastWords.wav",
106 sound  SOUND_FIRE        "Models\\Enemies\\Merasmus\\Sounds\\Fire.wav",
108 sound  SOUND_CHIMES      "Models\\Enemies\\Merasmus\\Sounds\\Chimes.wav",
107 sound  SOUND_MATERIALIZE "Models\\Enemies\\Merasmus\\Sounds\\Materialize.wav",
109 sound  SOUND_TELEPORT    "Models\\Enemies\\Merasmus\\Sounds\\Teleport.wav",

// ***** TAUNTS ******
150 sound  SOUND_TAUNT01    "Models\\Enemies\\Merasmus\\Sounds\\Quote03.wav",
151 sound  SOUND_TAUNT02    "Models\\Enemies\\Merasmus\\Sounds\\Quote05.wav",
152 sound  SOUND_TAUNT03    "Models\\Enemies\\Merasmus\\Sounds\\Quote07.wav",
153 sound  SOUND_TAUNT04    "Models\\Enemies\\Merasmus\\Sounds\\Quote08.wav",
154 sound  SOUND_TAUNT05    "Models\\Enemies\\Merasmus\\Sounds\\Quote10.wav",
155 sound  SOUND_TAUNT06    "Models\\Enemies\\Merasmus\\Sounds\\Quote11.wav",
156 sound  SOUND_TAUNT07    "Models\\Enemies\\Merasmus\\Sounds\\Quote14.wav",
157 sound  SOUND_TAUNT08    "Models\\Enemies\\Merasmus\\Sounds\\Quote15.wav",
158 sound  SOUND_TAUNTLAST  "Models\\Enemies\\Merasmus\\Sounds\\Quote16.wav",

// [Cecil] Appearance quote
160 sound SOUND_APPEAR "Models\\Enemies\\Merasmus\\Sounds\\Appear.wav",
...
functions:
  ...
  {
    if ( slPropertyOffset >= offsetof(CMerasmus, m_penGroup01Template01) &&
      slPropertyOffset <= offsetof(CMerasmus, m_penGroup03Template06))
    {
    ...
    if( slPropertyOffset == offsetof(CMerasmus, m_penControlArea))
    {
    ...
    if( slPropertyOffset == offsetof(CMerasmus, m_penSpawnMarker))
    {
    ...
    if( slPropertyOffset == offsetof(CMerasmus, m_penTeleportMarker) ||
        slPropertyOffset == offsetof(CMerasmus, m_penDeathMarker))
    {
  ...
  BOOL DoSafetyChecks(void) {
    ...
    if (m_penSpawnMarker==NULL) {
      WarningMessage( "No valid Spawn Marker for Merasmus boss! Destroying boss...");
      return FALSE;
    }
    if (m_penTeleportMarker==NULL) {
      WarningMessage( "No valid Teleport Marker for Merasmus boss! Destroying boss...");
      return FALSE;
    }
    if (m_penDeathMarker==NULL) {
      WarningMessage( "No valid Death Marker for Merasmus boss! Destroying boss...");
      return FALSE;
    }
    if (m_penControlArea==NULL) {
      WarningMessage( "No valid Area Marker for Merasmus boss! Destroying boss...");
      return FALSE;
    }
  ...
  {
    CTString str;
    str.PrintF(TRANS("Merasmus unsummoned %s"), strPlayerName);
    return str;
  }
  
  virtual const CTFileName &GetComputerMessageName(void) const {
    static DECLARE_CTFILENAME(fnm, "Data\\Messages\\Enemies\\Merasmus.txt");
    return fnm;
  };
  ...
  void RecalculateFuss(void)
  {
    ...
    for (INDEX i=0; i<apenNearEntities.Count(); i++)
    {
      if (IsDerivedFromClass(apenNearEntities[i], "Enemy Base") &&
        !IsOfClass(apenNearEntities[i], "Merasmus")) {
