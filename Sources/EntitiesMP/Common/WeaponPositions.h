...
wpn_fH[W_KNIFE]=(FLOAT)0;
wpn_fP[W_KNIFE]=(FLOAT)0;
wpn_fB[W_KNIFE]=(FLOAT)0;
wpn_fX[W_KNIFE]=(FLOAT)0;
wpn_fY[W_KNIFE]=(FLOAT)0;
wpn_fZ[W_KNIFE]=(FLOAT)0.05;
wpn_fFOV[W_KNIFE]=(FLOAT)60;
wpn_fClip[W_KNIFE]=(FLOAT)0.1;
wpn_fFX[W_KNIFE]=(FLOAT)0;
wpn_fFY[W_KNIFE]=(FLOAT)0;

wpn_fH[W_COLT]=(FLOAT)0;
wpn_fP[W_COLT]=(FLOAT)0;
wpn_fB[W_COLT]=(FLOAT)0;
wpn_fX[W_COLT]=(FLOAT)0;
wpn_fY[W_COLT]=(FLOAT)0;
wpn_fZ[W_COLT]=(FLOAT)0.05;
wpn_fFOV[W_COLT]=(FLOAT)60;
wpn_fClip[W_COLT]=(FLOAT)0.1;
wpn_fFX[W_COLT]=(FLOAT)0;
wpn_fFY[W_COLT]=(FLOAT)0;

wpn_fH[W_DCOLT]=(FLOAT)0;
wpn_fP[W_DCOLT]=(FLOAT)0;
wpn_fB[W_DCOLT]=(FLOAT)0;
wpn_fX[W_DCOLT]=(FLOAT)0;
wpn_fY[W_DCOLT]=(FLOAT)0;
wpn_fZ[W_DCOLT]=(FLOAT)0.05;
wpn_fFOV[W_DCOLT]=(FLOAT)60;
...
wpn_fX[W_SS]=(FLOAT)0;
wpn_fY[W_SS]=(FLOAT)0;
wpn_fZ[W_SS]=(FLOAT)0.05;
wpn_fFOV[W_SS]=(FLOAT)60;
wpn_fClip[W_SS]=(FLOAT)0.1;
wpn_fFX[W_SS]=(FLOAT)0;
wpn_fFY[W_SS]=(FLOAT)0;

wpn_fH[W_TGUN]=(FLOAT)0;
wpn_fP[W_TGUN]=(FLOAT)0;
wpn_fB[W_TGUN]=(FLOAT)0;
wpn_fX[W_TGUN]=(FLOAT)0;
wpn_fY[W_TGUN]=(FLOAT)0;
wpn_fZ[W_TGUN]=(FLOAT)0.05;
wpn_fFOV[W_TGUN]=(FLOAT)60;
wpn_fClip[W_TGUN]=(FLOAT)0.1;
wpn_fFX[W_TGUN]=(FLOAT)0;
wpn_fFY[W_TGUN]=(FLOAT)0;

wpn_fH[W_MGUN]=(FLOAT)0;
wpn_fP[W_MGUN]=(FLOAT)0;
wpn_fB[W_MGUN]=(FLOAT)0;
wpn_fX[W_MGUN]=(FLOAT)0;
wpn_fY[W_MGUN]=(FLOAT)0;
wpn_fZ[W_MGUN]=(FLOAT)0.05;
wpn_fFOV[W_MGUN]=(FLOAT)60;
...
wpn_fX[W_RL]=(FLOAT)0;
wpn_fY[W_RL]=(FLOAT)0;
wpn_fZ[W_RL]=(FLOAT)0.05;
wpn_fFOV[W_RL]=(FLOAT)60;
wpn_fClip[W_RL]=(FLOAT)0.1;
wpn_fFX[W_RL]=(FLOAT)0;
wpn_fFY[W_RL]=(FLOAT)0;
...
wpn_fX[W_GL]=(FLOAT)0;
wpn_fY[W_GL]=(FLOAT)0;
wpn_fZ[W_GL]=(FLOAT)0.05;
wpn_fFOV[W_GL]=(FLOAT)60;
wpn_fClip[W_GL]=(FLOAT)0.1;
wpn_fFX[W_GL]=(FLOAT)0;
wpn_fFY[W_GL]=(FLOAT)0;

wpn_fH[W_CSAW]=(FLOAT)0;
wpn_fP[W_CSAW]=(FLOAT)0;
wpn_fB[W_CSAW]=(FLOAT)0;
wpn_fX[W_CSAW]=(FLOAT)0;
wpn_fY[W_CSAW]=(FLOAT)0;
wpn_fZ[W_CSAW]=(FLOAT)0.05;
wpn_fFOV[W_CSAW]=(FLOAT)60;
...
wpn_fH[W_SNIPER]=(FLOAT)0;
wpn_fP[W_SNIPER]=(FLOAT)0;
wpn_fB[W_SNIPER]=(FLOAT)0;
wpn_fX[W_SNIPER]=(FLOAT)0;
wpn_fY[W_SNIPER]=(FLOAT)0;
wpn_fZ[W_SNIPER]=(FLOAT)0.05;
wpn_fFOV[W_SNIPER]=(FLOAT)60;
...
wpn_fX[W_DS]=(FLOAT)0;
wpn_fY[W_DS]=(FLOAT)0;
wpn_fZ[W_DS]=(FLOAT)0.1;
wpn_fFOV[W_DS]=(FLOAT)70;
